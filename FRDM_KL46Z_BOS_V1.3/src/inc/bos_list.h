/*
 *  Copyright   : 2015 
 *  File name   : bos_list.h
 *	Author      : Dang Minh Phuong
 *	Description : Implement link list management, this code is borrowed from Linux kernel
 */
...
static __inline void hlist_add_behind(struct hlist_node *n,
